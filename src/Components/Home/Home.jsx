...
import { FaPhoneAlt, FaEnvelope, FaSearch, FaShoppingCart, FaBars } from "react-icons/fa";
    ...
    <div className="home-page">
      ...
      <div className="top-bar d-flex justify-content-between align-items-center px-3 py-2">
        <div className="contact-info">
          <FaPhoneAlt className="me-2" /> (+123) 123 4567 890 &nbsp;&nbsp;
          <FaEnvelope className="me-2" /> info@domain.com
        </div>
      </div>
