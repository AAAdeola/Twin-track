...
//   // ✅ FIXED: renderMaterials so it separates names correctly and allows click
...
export default function WorkerTasksPage() {
  ...
  // ✅ FIXED: When return succeeds, remove material from UI
  const handleReturnSubmit = async (material, qtyToReturn) => {
    const pid = modalContext.task.projectId;
    const p = projectsData[pid];
    const supervisorId = p?.leadSupervisorId || null;
    ...
    try {
      ...
      // 🧩 Remove returned material from UI immediately
